pipeline{
    ...
    stages {
        ...
        stage ('Publish To Nexus') {
            steps {
                nexusArtifactUploader artifacts: [[artifactId: 'brightdevopslab', classifier: '', file: 'target/brightdevopslab-0.0.66-SNAPSHOT.war', type: 'war']], credentialsId: '5c98ee06-f735-4b4b-8a9e-142d0b151fdf', groupId: 'com.brightdevopslab', nexusUrl: '92.168.1.217:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'http://192.168.1.217:8081/repository/BrightDevopsLab-SNAPSHOT/', version: '0.0.66-SNAPSHOT'
            }
        }
